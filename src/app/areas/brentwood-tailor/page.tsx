...
export const metadata: Metadata = {
  title: 'Tailor Brentwood | Santa Monica Tailor by Bello',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div className="lg:col-span-2">
                <h2 className="font-serif text-ivory" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 400 }}>
                  Expert Tailoring Serving Brentwood
                </h2>
                <p className="text-gray-bello mt-5" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  Santa Monica Tailor by Bello has been serving clients from Brentwood and the surrounding areas since 2004. Our studio at 724 Santa Monica Blvd is conveniently located for Brentwood residents seeking expert tailoring, suit alterations, custom suits, and luxury garment care.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  Brentwood clients appreciate our convenient location on Santa Monica Blvd, easily accessible via San Vicente or Sunset.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>

...
const post = JOURNAL_POSTS['wedding-suit-timeline'];
...
export default function BlogPost() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Journal', path: '/journal' }, { name: post.title, path: '/journal/wedding-suit-timeline' }])) }} />
      <Navbar />

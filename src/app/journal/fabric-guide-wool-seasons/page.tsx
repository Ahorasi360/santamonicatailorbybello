...
const post = JOURNAL_POSTS['fabric-guide-wool-seasons'];
...
export default function BlogPost() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Journal', path: '/journal' }, { name: post.title, path: '/journal/fabric-guide-wool-seasons' }])) }} />
      <Navbar />

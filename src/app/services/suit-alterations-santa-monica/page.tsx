...
export const metadata: Metadata = {
  title: 'Suit Alterations Santa Monica | Santa Monica Tailor by Bello',
...
const SERVICE_SCHEMA = {
  ...
  description: 'Professional suit alterations in Santa Monica by master tailor Javier Bello.',
  provider: {
    '@type': 'LocalBusiness',
...
const FEATURES = ["Jacket tapering and waist suppression", "Sleeve shortening and lengthening", "Trouser hemming and tapering", "Shoulder adjustments", "Full suit resizing"];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div className="lg:col-span-2">
                ...
                <p className="text-gray-bello mt-6" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  Our alteration services cover everything from simple trouser hemming to complex jacket restructuring. We work with suits from every major brand — Hugo Boss, Ralph Lauren, Armani, Tom Ford, Brioni, and more — and our alterations are executed with the same precision as our bespoke work.
                </p>

...
const post = JOURNAL_POSTS['bespoke-vs-made-to-measure'];
...
export default function BlogPost() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Journal', path: '/journal' }, { name: post.title, path: '/journal/bespoke-vs-made-to-measure' }])) }} />
      <Navbar />

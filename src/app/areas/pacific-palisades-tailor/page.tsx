...
const area = AREAS['pacific-palisades-tailor'];

export const metadata: Metadata = {
  title: 'Tailor Pacific Palisades',
...
export default function LocationPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Areas We Serve', path: '/#areas' }, { name: 'Pacific Palisades', path: '/areas/pacific-palisades-tailor' }])) }} />

...
export const metadata: Metadata = {
  title: 'Tailor Bel Air',
  description: 'Expert tailoring and alterations serving Bel Air. Discreet, high-end tailoring and luxury brand alterations for Bel Air residents.',
  alternates: { canonical: `${SITE_URL}/areas/bel-air-tailor` },
  openGraph: {
    title: 'Tailor Bel Air',
    description: 'Expert tailoring and alterations serving Bel Air. Discreet, high-end tailoring and luxury brand alterations for Bel Air residents.',
    url: `${SITE_URL}/areas/bel-air-tailor`,
    images: [{ url: IMAGES.hero, width: 1200, height: 630, alt: 'Santa Monica Tailor by Bello serving Bel Air' }],
  },
};
...
const LOCAL_SCHEMA = {
  ...
  areaServed: { '@type': 'City', name: 'Bel Air' },
};
...
export default function LocationPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Areas We Serve', path: '/#areas' }, { name: 'Bel Air', path: '/areas/bel-air-tailor' }])) }} />
      <Navbar />
        ...
        <section className="relative flex items-end overflow-hidden" style={{ minHeight: '45vh' }}>
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-16">
            <nav className="flex items-center gap-2 mb-6" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              ...
              <span style={{ color: 'oklch(45% 0.005 240)' }}>›</span>
              <span style={{ color: 'oklch(73% 0.08 75)' }}>Bel Air</span>
            </nav>
            <p className="text-eyebrow">Serving Bel Air</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div className="lg:col-span-2">
                <h2 className="font-serif text-ivory" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 400 }}>
                  Expert Tailoring Serving Bel Air
                </h2>
                <p className="text-gray-bello mt-5" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  Santa Monica Tailor by Bello has been serving clients from Bel Air and the surrounding areas since 2004. Our studio at 724 Santa Monica Blvd is conveniently located for Bel Air residents seeking expert tailoring, suit alterations, custom suits, and luxury garment care.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  We serve Bel Air clients with the discretion and attention to detail that the neighbourhood demands. Our Santa Monica studio is easily accessible via Sunset or the 405.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>

...
export const metadata: Metadata = {
  title: 'Tailor Malibu',
  description: 'Expert tailoring and alterations serving Malibu. Custom suits, luxury brand alterations, and premium tailoring for Malibu residents.',
  alternates: { canonical: `${SITE_URL}/areas/malibu-tailor` },
  openGraph: {
    title: 'Tailor Malibu',
    description: 'Expert tailoring and alterations serving Malibu. Custom suits, luxury brand alterations, and premium tailoring for Malibu residents.',
    url: `${SITE_URL}/areas/malibu-tailor`,
    images: [{ url: IMAGES.hero, width: 1200, height: 630, alt: 'Santa Monica Tailor by Bello serving Malibu' }],
  },
};
...
const LOCAL_SCHEMA = {
  ...
  areaServed: { '@type': 'City', name: 'Malibu' },
};
...
export default function LocationPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Areas We Serve', path: '/#areas' }, { name: 'Malibu', path: '/areas/malibu-tailor' }])) }} />
      <Navbar />
        ...
        <section className="relative flex items-end overflow-hidden" style={{ minHeight: '45vh' }}>
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-16">
            <nav className="flex items-center gap-2 mb-6" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              ...
              <span style={{ color: 'oklch(45% 0.005 240)' }}>›</span>
              <span style={{ color: 'oklch(73% 0.08 75)' }}>Malibu</span>
            </nav>
            <p className="text-eyebrow">Serving Malibu</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div className="lg:col-span-2">
                <h2 className="font-serif text-ivory" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 400 }}>
                  Expert Tailoring Serving Malibu
                </h2>
                <p className="text-gray-bello mt-5" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  Santa Monica Tailor by Bello has been serving clients from Malibu and the surrounding areas since 2004. Our studio at 724 Santa Monica Blvd is conveniently located for Malibu residents seeking expert tailoring, suit alterations, custom suits, and luxury garment care.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  We welcome Malibu clients at our Santa Monica studio, a straightforward drive along the Pacific Coast Highway or via Sunset.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>

...
export const metadata: Metadata = {
  ...
  description: 'Expert alterations for luxury brands in Santa Monica. Brioni, Tom Ford, Armani, Kiton, Canali, and all major luxury garments handled with precision.',
...
const SERVICE_SCHEMA = {
  ...
  description: 'Expert alterations for luxury brands in Santa Monica. Brioni, Tom Ford, Armani, Kiton, Canali handled with precision.',
  provider: {
    '@type': 'LocalBusiness',
...
const FEATURES = ["Brioni, Kiton and Canali alterations", "Tom Ford and Armani tailoring", "Hermes and luxury casual wear", "Designer jacket and trouser alterations", "Preservation of original construction"];
    ...
    <>
      ...
      <main className="pt-[72px]">
        <section className="relative flex items-end overflow-hidden" style={{ minHeight: '50vh' }}>
          <div className="absolute inset-0" style={{ backgroundImage: `url(https://d2xsxph8kpxj0f.cloudfront.net/310519663296530547/HiNwGCzzPXbrMcuD99ygxU/bello-portfolio-2-new-EwJGzRgo5SAay7ZL9YDPvp.webp)`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-16">
            <nav className="flex items-center gap-2 mb-6" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              ...
              <span style={{ color: 'oklch(45% 0.005 240)' }}>›</span>
              <span style={{ color: 'oklch(73% 0.08 75)' }}>Luxury Brand Alterations Santa Monica</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div className="lg:col-span-2">
                ...
                <p className="text-gray-bello mt-6" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  From Brioni and Kiton to Tom Ford, Armani, and Canali, we alter luxury garments with the same care and precision as their original makers. Our approach preserves the integrity of the original construction while achieving the fit that transforms a luxury garment into a truly personal piece.
                </p>

...
const post = JOURNAL_POSTS['how-a-suit-should-fit'];
...
export default function BlogPost() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Journal', path: '/journal' }, { name: post.title, path: '/journal/how-a-suit-should-fit' }])) }} />
      <Navbar />

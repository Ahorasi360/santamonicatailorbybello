...
export const metadata: Metadata = {
  title: 'Tailor Beverly Hills',
  description: 'Expert tailoring and alterations serving Beverly Hills. Custom suits, luxury brand alterations, and precision tailoring for Beverly Hills clientele.',
  alternates: { canonical: `${SITE_URL}/areas/beverly-hills-tailor` },
  openGraph: {
    title: 'Tailor Beverly Hills',
    description: 'Expert tailoring and alterations serving Beverly Hills. Custom suits, luxury brand alterations, and precision tailoring for Beverly Hills clientele.',
    url: `${SITE_URL}/areas/beverly-hills-tailor`,
    images: [{ url: IMAGES.hero, width: 1200, height: 630, alt: 'Santa Monica Tailor by Bello serving Beverly Hills' }],
  },
};
...
const LOCAL_SCHEMA = {
  ...
  areaServed: { '@type': 'City', name: 'Beverly Hills' },
};
...
export default function LocationPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildBreadcrumb([{ name: 'Areas We Serve', path: '/#areas' }, { name: 'Beverly Hills', path: '/areas/beverly-hills-tailor' }])) }} />
      <Navbar />
        ...
        <section className="relative flex items-end overflow-hidden" style={{ minHeight: '45vh' }}>
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-16">
            <nav className="flex items-center gap-2 mb-6" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              ...
              <span style={{ color: 'oklch(45% 0.005 240)' }}>›</span>
              <span style={{ color: 'oklch(73% 0.08 75)' }}>Beverly Hills</span>
            </nav>
            <p className="text-eyebrow">Serving Beverly Hills</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div className="lg:col-span-2">
                <h2 className="font-serif text-ivory" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 400 }}>
                  Expert Tailoring Serving Beverly Hills
                </h2>
                <p className="text-gray-bello mt-5" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  Santa Monica Tailor by Bello has been serving clients from Beverly Hills and the surrounding areas since 2004. Our studio at 724 Santa Monica Blvd is conveniently located for Beverly Hills residents seeking expert tailoring, suit alterations, custom suits, and luxury garment care.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
                  We serve Beverly Hills clients from our Santa Monica studio, just minutes from Rodeo Drive and the Beverly Hills business district.
                </p>
                <p className="text-gray-bello mt-4" style={{ fontFamily: 'var(--font-sans)', fontSize: '0.95rem', lineHeight: 1.9 }}>
